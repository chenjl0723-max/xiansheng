...
def init_pc(year):
    ...
    process_map = {
        ...
        "Scenario": "Scenario{Actual;New;Past;Budget;Difference;Forecast;Combinaion;Adj01;Adj02;Adj03;Adj04;NoScenario}",
    }
...
def merge_process_block_entity(year):
    table_client = DataTableClickHouse("process_control_WS_cube")
    ...
    table_client = DataTableClickHouse("datatable_block_control_WS_cube")
...
def main(p1, p2):
    ...
    print(merge_data)
    # 业务模型初始化
    data_to_sql("ApprovalProgressRecord", merge_data, year, "Budget")
    print("业务模型初始化完成。")
