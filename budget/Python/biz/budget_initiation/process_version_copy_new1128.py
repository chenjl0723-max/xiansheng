...
def copy_ps(p2, cube_bewg, Year):
    ...
    df_ps = fun_qurey_dimension('Entity', 'Entity{IDescendant(1,0)}', ['name'])
    ...
    df_ps_01 = cube_bewg.query("Year{%s}->Entity{%s}->Scenario{Budget;New}->Version{Y1}->Measure{%s}->Material{IDescendant(Total,0)}->Department{IDescendant(Totaldepartment,0)}->Account{Base(#root,0);PL0101;PL010101;PL010102;PL0102;PL01;PL01020202;PL010201;PL010203;YW0208;PL01020401;PL01020402;PL010206;PL010207;PL010208;PL010209;PL010210;PL010211;PL010213;PL010214;PL010215;PL010218}"
                               % (Year, ps, measure), compact=False)
    df_ps_02 = cube_bewg.query("Year{%s}->Entity{%s}->Scenario{Actual;Forecast;Difference}->Version{Y1}->"
                               "Measure{%s}->Material{IDescendant(Total,0)}->Department{IDescendant(Totaldepartment,0)}->Account{Base(#root,0);PL0101;PL010101;PL010102;PL0102;PL01;PL01020202;PL010201;PL010203;YW0208;PL01020401;PL01020402;PL010206;PL010207;PL010208;PL010209;PL010210;PL010211;PL010213;PL010214;PL010215;PL010218}" % (str(int(Year) - 1), ps, measure), compact=False)
    df_ps = df_ps_01.append(df_ps_02).reset_index(drop=True, inplace=False)
    # 数据操作cube
    # 先删
    fix_del = "Year{%s}->Entity{%s}->Scenario{Budget;New}->Version{%s}->Measure{%s}->Material{IDescendant(Total,0)}->Department{IDescendant(Totaldepartment,0)}->Account{Base(#root,0);PL0101;PL010101;PL010102;PL0102;PL01;PL01020202;PL010201;PL010203;YW0208;PL01020401;PL01020402;PL010206;PL010207;PL010208;PL010209;PL010210;PL010211;PL010213;PL010214;PL010215;PL010218}" \
              % (Year, ps, p2['version_to'], measure)
    d = cube_bewg.delete(fix_del)
    print('ps复制前删除Budget;New：', d, p2['version_to'])
    fix_del = "Year{%s}->Entity{%s}->Scenario{Actual;Forecast;Difference}->Version{%s}->Measure{%s}->Material{IDescendant(Total,0)}->Department{IDescendant(Totaldepartment,0)}->Account{Base(#root,0);PL0101;PL010101;PL010102;PL0102;PL01;PL01020202;PL010201;PL010203;YW0208;PL01020401;PL01020402;PL010206;PL010207;PL010208;PL010209;PL010210;PL010211;PL010213;PL010214;PL010215;PL010218}" \
