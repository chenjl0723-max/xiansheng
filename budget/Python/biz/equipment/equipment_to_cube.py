...
def main(p1, p2):
    ...
    if dt_equipment.size > 0:
        ...
        # 表单10：new_equipment 新增设施预算调整(技改)
            ...
            # 处理预算金额
            column = ['year', 'entity', 'department', 'scenario', 'version', 'sum_new']
            dt_equipment_sum = equipment_overhaul_repurchase(dt_equipment, column, 'sum_new', 'PL0304','Expenses')
            # 处理审核金额
            column = ['year', 'entity', 'department', 'scenario', 'version', 'district_amount_new']
            dt_equipment_area = equipment_overhaul_repurchase(dt_equipment, column, 'district_amount_new',
                                                              account, 'Areaaccount')
...
if __name__ == '__main__':
    try:
        ...
        pass
    p2 = {'elementName': 'equipment_overhaul_repurchase_float',
          'folderId': 'DIRe667e90baafd',
          'sheetName': '非技改-设备大修重置预算填报',
          'sheetId': 'SHTc9305cc22a394562bcfd253dedf3ef96',
          'Year_wb1': '2025',
          'Entity_wb1': 'Base(1,0)',
