...
class kafka_():
    ...
    def __init__(self):
        self.topic = "mdms-ypyj-all"
        self.group_id = kafka_setting_main["group_id_ws"]
        self.servers = kafka_setting_main["bootstrap_servers"]
