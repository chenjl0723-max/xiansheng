...
class PipeNetBasic(object):
    ...
    def clear_data(self, cube):
        ...
        print("管网清数完成：所有 Noperiod 已删除，计算科目月度已清除，手工数据保留")
    ...
    def calc_actual_monthly(self, df, forecast_val, cube):
        ...
        # 电度合计 = 泵站 + 其他
        df_actual["SYW020505"] = df_actual["SYW020509"] + df_actual["SYW020510"]
    ...
    def calc_forecast_monthly(self, df, forecast_val, cube):
        ...
        # 电度合计 = 泵站 + 其他
        df_forecast["SYW020505"] = df_forecast["SYW020509"] + df_forecast["SYW020510"]
    ...
    def calc_budget_monthly(self, df, cube):
        ...
        # 电度合计 = 泵站 + 其他
        df_budget["SYW020505"] = df_budget["SYW020509"] + df_budget["SYW020510"]
    ...
    def calc_noperiod_all_scenarios(self, cube, forecast_val):
        ...
        sum_accounts = [
            ...
            "SYW020501", "SYW020503", "SYW020505", "SYW020509", "SYW020510", "SYW020513",
        ]
    ...
    def run_all(self, cube, forecast_val):
        print("管网基础生产数据计算流程开始".center(70, "="))
        ...
        print("管网基础生产数据计算全部完成".center(70, "="))
...
def main(p1, p2):
    ...
    pipe_net = PipeNetBasic(p2)
    pipe_net.run_all(cube, forecast_val)
